    ...
    <div className={className}>
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => <blockquote className="border-l-2 border-[var(--accent)] pl-4 italic mb-4">{children}</blockquote>,
          code: ({ children }) => <code className="bg-surface-container-low border border-outline-variant/30 px-1 py-0.5 text-sm">{children}</code>,
